...
##  Mini-lecture: Why link functions matter in binomial GLMs

### Choice of link for binomial regression models
...
### Compare inverse links $g^{-1}(\eta)$ directly
...
## Overdispersion: Correlated Binary Observations
...
### Correlated binary outcomes and intraclass correlation
...
### Mixture models: Beta-binomial models
